					...
					<div class="row">
						<div class="col-12">
							...
							<div class="breadcrumb_text">
								<p><a href="#">Home</a> | <span>Panier</span></p>
							</div>
						</div>
						<!-- /.col-12 -->
					</div>
...
<table border="1">
<tr>
<td style="color:black;">Reference</td>
<td style="color:black;">Nom</td>
<td style="color:black;">Mail</td>
<td style="color:black;">Quantite</td>
<td style="color:black;">Date</td>
<td style="color:black;">Adresse</td>
<td style="color:black;">supprimer</td>
<td style="color:black;">modifier</td>
</tr>
...
foreach($listeEmployes as $row){
	?>
	<tr>
	<td style="color:black;"><?PHP echo $row['reference']; ?></td>
	<td style="color:black;"><?PHP echo $row['nom']; ?></td>
	<td style="color:black;"><?PHP echo $row['mail']; ?></td>
	<td style="color:black;"><?PHP echo $row['telephone']; ?></td>
	<td style="color:black;"><?PHP echo $row['date']; ?></td>
	<td style="color:black;"><?PHP echo $row['adresse']; ?></td>
	<td style="color:black;"><form method="POST" action="supprimerEmploye.php">
