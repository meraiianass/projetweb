...
if (isset($_POST['modifier'])){
	...
	$employeC->modifierEmploye($employe,$_POST['reference']);
...
?>
	...
	<div id="site">
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="breadcrumb_text">
								<p><a href="#">Home</a> | <span>Modification</span></p>
							</div>
						</div>
						<!-- /.col-12 -->
					</div>
		...
		<!--=        SuppSer         =-->
		<!--=========================-->
		<section class="supplement_service_area_two section_padding_two">
			<div class="vigo_container_two">
				<div class="row">
					<div class="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
						<div class="section_title_two">
							...
							<p>To purchase our product, please Enter the name of the product and the quantity desired and your recommendations and hit Continue
							</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-6">
						<div class="supp_ser_list">
							<div class="single_supp_ser">
                 ...
                 <form method="POST">                                                                                                                                    							
										<div class="ref" >
										<input type="number" required="required" name="reference" placeholder="Réference du produit" id="prod" value="<?PHP echo $reference ?>" />
										
									</div>
									<div class="nom" >
										<input type="text" required="required" name="nom" placeholder="Nom du Produit" id="nom" value="<?PHP echo $nom ?>" />
										
									</div>
									<div class="mail" >
										<input type="text" required="required" name="mail" placeholder="Votre mail" id="mail" value="<?PHP echo $mail ?>" />
										
									</div>

									<div class="telephone" >
										<input type="number" required="required" name="telephone" placeholder="Quantite" id="telephone" value="<?PHP echo $telephone ?>" />
										
									</div>

									<div class="date">
										<input type="text" required="required" name="date"  placeholder="date" id="date" value="<?PHP echo $date ?>">
										
									</div>

									<div class="adresse">
										<input type="text" required="required" name="adresse"  placeholder="adresse" id="adresse" value="<?PHP echo $adresse ?>">
					...
					<div class="col-xl-6">
						<div class="supplement_service_img">
							<img src="media/images/banner-two/supp-ser2.png" alt="">
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-xl-8 offset-xl-2">
							<div class="testimonial-carousel owl-carousel owl-theme">
								<div class="single-testimonial-two">
									...
									<p>Supplement is a manufactured product and the right kind of protein to get its health benefits. manufactured product intended right amount and the right kind of protein” </p>
									<div class="tes-img">
				...
				<div class="row">
					<div class="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
						<div class="section_title_two">
							...
							<img src="media/images/banner-two/hm-two-title.png" alt="">
							<p>Our product is fully personalized and well balanced for all age of customers or adults. We maintain the standards by lorem ipsum and certified by dolor set amet.
							</p>
						</div>
					</div>
				</div>
					...
					<div class="col-xl-12 ">
						<div class="portfolio-inner-wrapper">
							<ul class="filter-button">
								...
								<li class="filter" data-filter=".two">Protein</li>
								<li class="filter" data-filter=".three">Life Style</li>
								<li class="filter" data-filter=".four">Nutrition</li>
								<li class="filter" data-filter=".five">Vitamins</li>
							</ul>
							<div class="grid row">
								<!-- single product -->
								<div class=" grid-item two col-6 col-sm-6 col-md-4  col-lg-4 col-xl-4">
									<div class="sin-portfolio style-one">
										<a href="media/images/product-two/p1.jpg" title="Bodybuilding Drug" data-effect="mfp-move-horizontal">
									<img src="media/images/product-two/p1.jpg" alt="">
								</a>
										<div class="overlay"></div>
										<div class="portfolio_details">
											<a href="media/images/product/p1.jpg" title="Bodybuilding Drug" data-effect="mfp-move-horizontal">
												<h5>bodybuilding <span>drug</span></h5>
												<span>Vitamin capsule</span>
											</a>
										</div>
										<!-- /.portfolio_details -->
									</div>
								...
								<!-- single product -->
								<div class=" grid-item three col-6 col-sm-6 col-md-4  col-lg-4 col-xl-4">
									<div class="sin-portfolio style-one">
										<a href="media/images/product-two/p2.jpg" title="Vaxin Antioxident" data-effect="mfp-move-horizontal">
							<img src="media/images/product-two/p2.jpg" alt="">
						</a>
										<div class="overlay"></div>
										<div class="portfolio_details">
											<a href="media/images/product/p2.jpg" title="Bodybuilding Drug" data-effect="mfp-move-horizontal">
												<h5>bodybuilding <span>drug</span></h5>
												<span>Vitamin capsule</span>
											</a>
										</div>
								...
								<!-- single product -->
								<div class=" grid-item four col-6 col-sm-6 col-md-4  col-lg-4 col-xl-4">
									<div class="sin-portfolio style-one">
										<a href="media/images/product-two/p3.jpg" title="Vaxin Hydration" data-effect="mfp-move-horizontal">
							<img src="media/images/product-two/p3.jpg" alt="">
						</a>
										<div class="overlay"></div>
										<div class="portfolio_details">
											<a href="media/images/product/p3.jpg" title="Bodybuilding Drug" data-effect="mfp-move-horizontal">
												<h5>bodybuilding <span>drug</span></h5>
												<span>Vitamin capsule</span>
											</a>
										</div>
								...
								<!-- single product -->
								<div class=" grid-item five col-6 col-sm-6 col-md-4  col-lg-4 col-xl-4">
									<div class="sin-portfolio style-one">
										<a href="media/images/product-two/p6.jpg" title="Vaxin Collagen" data-effect="mfp-move-horizontal">
							<img src="media/images/product-two/p6.jpg" alt="">
						</a>
										<div class="overlay"></div>
										<div class="portfolio_details">
											<a href="media/images/product/p6.jpg" title="Bodybuilding Drug" data-effect="mfp-move-horizontal">
												<h5>bodybuilding <span>drug</span></h5>
												<span>Vitamin capsule</span>
											</a>
										</div>
								...
								<!-- single product -->
								<div class=" grid-item one col-6 col-sm-6 col-md-4  col-lg-4 col-xl-4">
									<div class="sin-portfolio style-one">
										<a href="media/images/product-two/p4.jpg" title="Vaxin Fixin" data-effect="mfp-move-horizontal">
									<img src="media/images/product-two/p4.jpg" alt="">
								</a>
										<div class="overlay"></div>
										<div class="portfolio_details">
											<a href="media/images/product/p4.jpg" title="Bodybuilding Drug" data-effect="mfp-move-horizontal">
												<h5>bodybuilding <span>drug</span></h5>
												<span>Vitamin capsule</span>
											</a>
										</div>
								...
								<div class=" grid-item two col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
									<div class="sin-portfolio style-one">
										<a href="media/images/product-two/p5.jpg" title="Vaxin Natural" data-effect="mfp-move-horizontal">
									<img src="media/images/product-two/p5.jpg" alt="">
								</a>
										<div class="overlay"></div>
										<div class="portfolio_details">
											<a href="media/images/product/p5.jpg" title="Bodybuilding Drug" data-effect="mfp-move-horizontal">
												<h5>bodybuilding <span>drug</span></h5>
												<span>Vitamin capsule</span>
											</a>
										</div>
					...
					<div class="col-xl-12">
						<div class="call_to_action_hello">
							...
							<div class="call_to_action_right_two">
								<a href="#" class="btn_two">Purchase</a>
							</div>
						</div>
					</div>
				</div>
